    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-foreground mb-4">Publicação não encontrada</h1>
          <Button asChild><Link to="/publications"><ArrowLeft className="mr-2 h-4 w-4" /> Voltar para Publicações</Link></Button>
        </div>
      </div>
    );
  }
      ...
      <section className="bg-hero py-16 lg:py-20">
        <div className="container mx-auto px-4">
          <Link to="/publications" className="inline-flex items-center text-primary-foreground/70 hover:text-primary-foreground text-sm mb-4 transition-colors">
            <ArrowLeft className="mr-1 h-4 w-4" /> Voltar para Publicações
          </Link>
            ...
            <div className="space-y-6">
              <FadeUp delay={0.1}>
                <div className="bg-card rounded-xl p-6 shadow-card">
                  <h3 className="font-bold text-foreground mb-4">Informações da Publicação</h3>
              ...
              <FadeUp delay={0.2}>
                <div className="bg-card rounded-xl p-6 shadow-card">
                  <h3 className="font-bold text-foreground mb-4">Autores</h3>
              ...
              {relatedProject && (
                <FadeUp delay={0.3}>
                  <div className="bg-card rounded-xl p-6 shadow-card">
                    <h3 className="font-bold text-foreground mb-4">Projeto Relacionado</h3>
