...
import { Sprout, Leaf, FlaskConical, Microscope, ArrowRight } from "lucide-react";
import { researchProjects } from "@/data/labData";

const themes = [
  { icon: Sprout, label: "Micropropagação", desc: "Cultivo in vitro e produção de mudas em larga escala" },
  { icon: Leaf, label: "Conservação de espécies nativas", desc: "Conservação ex situ de orquídeas e espécies ameaçadas" },
  { icon: Microscope, label: "Morfogênese in vitro", desc: "Embriogênese somática e organogênese" },
  { icon: FlaskConical, label: "Biotecnologia vegetal", desc: "Estudos bioquímicos e moleculares do desenvolvimento" },
];
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
      ...
      <section className="bg-research py-16 lg:py-20">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl lg:text-5xl font-extrabold text-primary-foreground tracking-tighter">Nossa Pesquisa</h1>
          <p className="text-primary-foreground/80 mt-4 max-w-2xl">O LMV-UFPR atua na propagação in vitro de plantas e suas aplicações biotecnológicas diversas, com ênfase em espécies nativas brasileiras, conservação e formação de recursos humanos.</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <FadeUp><h2 className="text-2xl font-bold text-foreground mb-8">Linhas de Pesquisa</h2></FadeUp>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <FadeUp><h2 className="text-2xl font-bold text-foreground mb-10">Projetos em Andamento</h2></FadeUp>
